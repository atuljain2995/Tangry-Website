    ...
    <>
      ...
      <section className="py-16 bg-gradient-to-br from-[#D32F2F] to-[#B71C1C] text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-red-200/90 text-sm mb-8 max-w-xl mx-auto">
            Links open search results for &ldquo;tangry&rdquo; until you replace them with your official storefront
            pages.
          </p>
